export const ENEMIES: Record<string, { name: string; expReward: number; goldReward: number; isElite?: boolean; isBoss?: boolean }> = {
  ...
  // Mud Swamps (lv 20-30)
  swamp_lurker: { name: "Swamp Lurker", expReward: 55, goldReward: 25 },
  bog_toad: { name: "Bog Toad", expReward: 50, goldReward: 22 },
  mud_golem: { name: "Mud Golem", expReward: 58, goldReward: 28 },
  marsh_hag: { name: "Marsh Hag", expReward: 62, goldReward: 30 },
  leech_swarm: { name: "Leech Swarm", expReward: 48, goldReward: 22 },
  rotting_treant: { name: "Rotting Treant", expReward: 56, goldReward: 26 },
  mire_crawler: { name: "Mire Crawler", expReward: 54, goldReward: 24 },
  toxic_spore: { name: "Toxic Spore", expReward: 52, goldReward: 24 },
  swamp_hydra: { name: "Swamp Hydra", expReward: 65, goldReward: 32 },
  sludge_beast: { name: "Sludge Beast", expReward: 60, goldReward: 28 },
  quicksand_wraith: { name: "Quicksand Wraith", expReward: 58, goldReward: 27 },
  fungal_horror: { name: "Fungal Horror", expReward: 62, goldReward: 30 },
  swamp_king: { name: "Swamp King", expReward: 800, goldReward: 400, isElite: true },
  ancient_hydra: { name: "Ancient Hydra", expReward: 950, goldReward: 475, isElite: true },
  bog_mother: { name: "Bog Mother", expReward: 600, goldReward: 300, isBoss: true },
  // Forgotten Cave (lv 30-40)
  cave_bat: { name: "Cave Bat", expReward: 72, goldReward: 32 },
  stone_golem: { name: "Stone Golem", expReward: 82, goldReward: 40 },
  crystal_spider: { name: "Crystal Spider", expReward: 78, goldReward: 36 },
  deep_dweller: { name: "Deep Dweller", expReward: 80, goldReward: 38 },
  blind_stalker: { name: "Blind Stalker", expReward: 85, goldReward: 40 },
  gem_beetle: { name: "Gem Beetle", expReward: 70, goldReward: 35 },
  cave_troll: { name: "Cave Troll", expReward: 88, goldReward: 42 },
  stalactite_mimic: { name: "Stalactite Mimic", expReward: 82, goldReward: 38 },
  tunnel_serpent: { name: "Tunnel Serpent", expReward: 78, goldReward: 36 },
  echo_wraith: { name: "Echo Wraith", expReward: 84, goldReward: 40 },
  mushroom_giant: { name: "Mushroom Giant", expReward: 80, goldReward: 38 },
  ore_elemental: { name: "Ore Elemental", expReward: 86, goldReward: 42 },
  crystal_guardian: { name: "Crystal Guardian", expReward: 1100, goldReward: 550, isElite: true },
  deep_horror: { name: "Deep Horror", expReward: 1300, goldReward: 650, isElite: true },
  cave_dragon: { name: "Cave Dragon", expReward: 900, goldReward: 450, isBoss: true },
  // Dark Seas (lv 40-50)
  drowned_sailor: { name: "Drowned Sailor", expReward: 120, goldReward: 55 },
  sea_serpent: { name: "Sea Serpent", expReward: 135, goldReward: 62 },
  ghost_pirate: { name: "Ghost Pirate", expReward: 130, goldReward: 60 },
  reef_golem: { name: "Reef Golem", expReward: 140, goldReward: 65 },
  abyssal_squid: { name: "Abyssal Squid", expReward: 132, goldReward: 60 },
  siren: { name: "Siren", expReward: 138, goldReward: 64 },
  barnacle_fiend: { name: "Barnacle Fiend", expReward: 125, goldReward: 58 },
  tide_elemental: { name: "Tide Elemental", expReward: 142, goldReward: 66 },
  shark_spirit: { name: "Shark Spirit", expReward: 145, goldReward: 68 },
  coral_wraith: { name: "Coral Wraith", expReward: 128, goldReward: 58 },
  deep_angler: { name: "Deep Angler", expReward: 136, goldReward: 62 },
  phantom_kraken: { name: "Phantom Kraken", expReward: 150, goldReward: 70 },
  leviathan: { name: "Leviathan", expReward: 2200, goldReward: 1100, isElite: true },
  ghost_captain: { name: "Ghost Captain", expReward: 2500, goldReward: 1250, isElite: true },
  kraken_lord: { name: "Kraken Lord", expReward: 1800, goldReward: 900, isBoss: true },
  // Volcano's Path (lv 60-70)
  lava_golem: { name: "Lava Golem", expReward: 200, goldReward: 92 },
  fire_imp: { name: "Fire Imp", expReward: 185, goldReward: 85 },
  magma_serpent: { name: "Magma Serpent", expReward: 210, goldReward: 98 },
  volcanic_drake: { name: "Volcanic Drake", expReward: 225, goldReward: 105 },
  ember_elemental: { name: "Ember Elemental", expReward: 215, goldReward: 100 },
  infernal_hound: { name: "Infernal Hound", expReward: 195, goldReward: 90 },
  ash_wraith: { name: "Ash Wraith", expReward: 205, goldReward: 95 },
  obsidian_knight: { name: "Obsidian Knight", expReward: 230, goldReward: 108 },
  flame_djinn: { name: "Flame Djinn", expReward: 220, goldReward: 102 },
  molten_spider: { name: "Molten Spider", expReward: 190, goldReward: 88 },
  pyroclast_titan: { name: "Pyroclast Titan", expReward: 235, goldReward: 110 },
  cinder_shade: { name: "Cinder Shade", expReward: 208, goldReward: 96 },
  magma_lord: { name: "Magma Lord", expReward: 3200, goldReward: 1600, isElite: true },
  infernal_dragon: { name: "Infernal Dragon", expReward: 3800, goldReward: 1900, isElite: true },
  volcano_guardian: { name: "Volcano Guardian", expReward: 2800, goldReward: 1400, isBoss: true },
  // Crystal Lands (lv 70-80)
  crystal_sentinel: { name: "Crystal Sentinel", expReward: 350, goldReward: 150 },
  prism_golem: { name: "Prism Golem", expReward: 380, goldReward: 170 },
  gem_wyrm: { name: "Gem Wyrm", expReward: 400, goldReward: 180 },
  refraction_spirit: { name: "Refraction Spirit", expReward: 370, goldReward: 165 },
  shard_elemental: { name: "Shard Elemental", expReward: 360, goldReward: 160 },
  diamond_spider: { name: "Diamond Spider", expReward: 375, goldReward: 168 },
  amethyst_knight: { name: "Amethyst Knight", expReward: 395, goldReward: 178 },
  quartz_phantom: { name: "Quartz Phantom", expReward: 385, goldReward: 172 },
  opal_shade: { name: "Opal Shade", expReward: 378, goldReward: 170 },
  ruby_construct: { name: "Ruby Construct", expReward: 410, goldReward: 185 },
  sapphire_serpent: { name: "Sapphire Serpent", expReward: 390, goldReward: 175 },
  topaz_guardian: { name: "Topaz Guardian", expReward: 420, goldReward: 190 },
  crystal_colossus: { name: "Crystal Colossus", expReward: 8000, goldReward: 4000, isElite: true },
  prismatic_dragon: { name: "Prismatic Dragon", expReward: 9500, goldReward: 4750, isElite: true },
  crystal_overlord: { name: "Crystal Overlord", expReward: 6500, goldReward: 3250, isBoss: true },
  // Tamma's Castle (lv 90-100)
  castle_knight: { name: "Castle Knight", expReward: 600, goldReward: 280 },
  dark_paladin: { name: "Dark Paladin", expReward: 650, goldReward: 300 },
  throne_guardian: { name: "Throne Guardian", expReward: 700, goldReward: 320 },
  cursed_duke: { name: "Cursed Duke", expReward: 680, goldReward: 310 },
  royal_revenant: { name: "Royal Revenant", expReward: 660, goldReward: 305 },
  shadow_vizier: { name: "Shadow Vizier", expReward: 720, goldReward: 340 },
  doom_sentinel: { name: "Doom Sentinel", expReward: 740, goldReward: 350 },
  fallen_champion: { name: "Fallen Champion", expReward: 730, goldReward: 345 },
  void_prince: { name: "Void Prince", expReward: 750, goldReward: 355 },
  death_bishop: { name: "Death Bishop", expReward: 710, goldReward: 335 },
  chaos_warden: { name: "Chaos Warden", expReward: 760, goldReward: 360 },
  nightmare_lord: { name: "Nightmare Lord", expReward: 740, goldReward: 348 },
  arch_demon: { name: "Arch Demon", expReward: 16000, goldReward: 8000, isElite: true },
  eternal_guardian: { name: "Eternal Guardian", expReward: 18000, goldReward: 9000, isElite: true },
  tamma_the_fallen: { name: "Tamma the Fallen", expReward: 25000, goldReward: 12500, isBoss: true },
};
