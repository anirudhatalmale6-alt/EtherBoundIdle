...
const WEAPON_SPRITE_COUNTS = {
  wand:       { common: 16, rare: 2, legendary: 1 },
  ...
  sword:      { common: 32, rare: 32, legendary: 7 },
  axe:        { common: 28, rare: 23, legendary: 2 },
  mace:       { common: 24, rare: 9, legendary: 8 },
  bow:        { common: 1, rare: 3, legendary: 3 },
  crossbow:   { common: 2, rare: 2, legendary: 2 },
  medium:       { common: 56, rare: 56, legendary: 56 },
  leather_helm: { common: 40, rare: 24, legendary: 64 },
  dagger:   { common: 4, rare: 12, legendary: 32 },
