...
- **Guild Boss Cooldown**: 60-minute cooldown between guild boss attacks. Stored in localStorage (`eb_guild_boss_last_attack_{charId}`) and mirrored to Supabase. GuildBoss.jsx shows countdown timer when on cooldown.
